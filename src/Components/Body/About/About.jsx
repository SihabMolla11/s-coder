    ...
    <div className="my-container" data-aos="fade-down">
      ...
      <div className="">
        ...
        <p className="text-lg text-white">
          ...
          Laravel, Prisma, Mongoose, PostgreSQL, MongoDB and My SQL. But my expertise doesn’t stop
          there. I bring aesthetic precision to frontend development with frameworks like Tailwind
          CSS, Bootstrap, Hero UI, Ant Design, ShadCN, and Material UI, ensuring that every UI is
          seamless, responsive, and visually stunning. On the backend, I architect robust, scalable,
          and high performance applications with modern technologies, delivering real world impact.
          <br />
          <br />
          ...
          and Swagger, I am always ready to explore deeper. My hunger for learning keeps me going,
          and my dedication ensures that I deliver the best possible solutions to every problem I
          encounter. <br />
          <br />
